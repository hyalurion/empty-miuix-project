...
-keep,includedescriptorclasses class com.hyalurion.exampleproject.ui.navigation.**$$serializer { *; }
-keepclassmembers class com.hyalurion.exampleproject.ui.navigation.** {
    *** Companion;
    public static ** INSTANCE;
}
-keepclasseswithmembers class com.hyalurion.exampleproject.ui.navigation.** {
