package com.hyalurion.exampleproject.ui.screens
...
import com.hyalurion.exampleproject.data.LicensesData
...
fun LicensesScreen(
    ...
    var selectedLicense by remember { mutableStateOf<com.hyalurion.exampleproject.data.LicenseInfo?>(null) }
    ...
    Scaffold(
        ...
        BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
            ...
            // On large screens the open-source list is capped to 80% width and centered, and the
            // license cards flow in a responsive grid (multiple per row) instead of one column.
            Box(
